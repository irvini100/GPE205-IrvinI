...
public class PowerupManager : MonoBehaviour
{
    ...
    public void DecrementPowerupTimers()
    {
        ...
        foreach(Powerup powerup in powerups)
        {
            ...
            //If it is time up, we want to remove this powerup'
    ...
    {
        //Now that we are sure that we are not iterating through "powerups", remove the powerups that are in our temporary list
